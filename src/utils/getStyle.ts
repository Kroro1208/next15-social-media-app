export const getRankStyling = (rank: number) => {
	if (rank === 0) {
		return {
			container:
				"border-yellow-300 dark:border-yellow-600 bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/30 dark:to-amber-900/30 shadow-xl",
		...
		return {
			container:
				"border-gray-300 dark:border-gray-600 bg-gradient-to-r from-gray-50 to-slate-50 dark:from-gray-800 dark:to-slate-800 shadow-lg",
		...
		return {
			container:
				"border-orange-300 dark:border-orange-600 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/30 dark:to-red-900/30 shadow-lg",
