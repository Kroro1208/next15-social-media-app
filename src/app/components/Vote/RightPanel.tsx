      ...
      <div className="sticky top-8">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-6 hover:shadow-2xl transition-all duration-300">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 p-3 bg-gray-50/80 dark:bg-gray-700/80 rounded-xl">
            ...
            <div className="flex items-start gap-3 p-3 bg-gray-50/80 dark:bg-gray-700/80 rounded-xl">
              <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                <div className="w-2 h-2 bg-white dark:bg-gray-300 rounded-full" />
              </div>
              <div>
                <div className="font-semibold text-gray-800 dark:text-gray-200 text-sm">
                  コメント数 × 0.5
          ...
          {/* 注意事項 */}
          <div className="mt-6 p-4 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 rounded-xl border border-amber-200 dark:border-amber-700">
